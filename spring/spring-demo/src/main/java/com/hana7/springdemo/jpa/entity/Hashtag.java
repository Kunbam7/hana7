...
// 			foreignKeyDefinition = "foreign ket (hashtag) references Hashtag(id) on  Delete cascade")
// 		),
// 	inverseJoinColumns = @JoinColumn(name = "board",
// 			foreignKey = @ForeignKey(name = "fk_HashtagBoard_board",
// 			foreignKeyDefinition = "foreign ket (board) references Board(id) on  Delete cascade")
// 		)
// 	)
//
